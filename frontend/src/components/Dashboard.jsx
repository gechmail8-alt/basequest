...
export default function Dashboard({ quests, wallet, setActiveTab }) {
  ...
  if (!isConnected) return (
    <div style={{ padding: "60px 20px", textAlign: "center" }}>
      <img src="/base.svg" style={{ width: "70px", marginBottom: "20px" }} />
  ...
  if (loading && !userProfile) return (
    <div style={{ padding: "60px 20px", textAlign: "center" }}>
      <img src="/loading.svg" style={{ width: "40px", marginBottom: "16px" }} />
  ...
  return (
    <div style={{ padding: "24px 0" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "16px", flexWrap: "wrap", gap: "12px" }}>
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                <img src="/level.svg" style={{ width: "34px" }} />
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(150px,1fr))", gap: "12px", marginBottom: "16px" }}>
        {[
          { label: "Tasks Completed", value: userProfile?.tasksCompleted?.toLocaleString() || "0", icon: "/tasks.svg", color: "#00c853" },
          ...
          <div key={stat.label} style={{
            ...
            <img src={stat.icon} style={{ width: "24px", marginBottom: "8px" }} />
